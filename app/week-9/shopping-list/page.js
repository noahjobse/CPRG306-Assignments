...
import { useUserAuth } from "../_utils/auth-context";  // Fixed path since we're in week-9/shopping-list
...
export default function Page() {
  ...
  if (!user) return <p>Please log in first</p>; // or redirect to landing page
